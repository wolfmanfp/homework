...
public class MSSQLKezeles implements AdatVezerlo{
    private String utvonal;
    private Connection kapcsolat;

    public MSSQLKezeles(String utvonal) {
        this.utvonal = utvonal;
    }
    
    /**
     * Kapcsolódik a Microsoft SQL adatbázishoz a konstruktorban megadott útvonal alapján.
     * @throws ClassNotFoundException
     * @throws SQLException 
     */
    private void kapcsolodas() throws ClassNotFoundException, SQLException{
        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        kapcsolat = DriverManager.getConnection(utvonal, "Wolfman", "wolfman");
    }
